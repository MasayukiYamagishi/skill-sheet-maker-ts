              ...
              <div className='card-body'>
                <h3 className='card-title'>
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin='round'
                      strokeWidth={2}
                      d='M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.793-1.256 2.793-2.793 0-.886-.365-1.695-.953-2.275L16.5 9.793c-.536-.896-1.676-1.195-2.556-.67L12 10.793l-1.944-1.67c-.88-.525-2.02-.226-2.556.67L5.5 13.732c-.588.58-.953 1.389-.953 2.275C4.547 17.744 5.803 19 7.343 19z'
                    />
                  </svg>
                  完了していない項目
                </h3>
                <div className='space-y-3'>
                  {mockMissingItems.map((item, index) => (
                    <div
                      key={index}
                      className='flex items-start space-x-3 p-3 bg-warning/10 rounded-lg'
                    >
