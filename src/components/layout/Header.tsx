...
import { APP_NAME, BUTTON_LABELS, MENU_LABELS, A11Y_LABELS } from '@/constants/ui';
        ...
        {user ? (
          <div className="dropdown dropdown-end">
            ...
            >
              ...
              <li><a>{MENU_LABELS.myProfile}</a></li>
              <li><a>{MENU_LABELS.settings}</a></li>
              <li><a>{MENU_LABELS.help}</a></li>
              <div className="divider my-1"></div>
              <li><a className="text-error">{MENU_LABELS.logout}</a></li>
            </ul>
          </div>
        ) : (
          <button className={COMMON_STYLES.btnPrimary}>{BUTTON_LABELS.login}</button>
        )}
      </div>
    </div>
  );
